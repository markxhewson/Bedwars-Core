...
public class ToolsShopMenu extends Menu {

    private final Bedwars instance;
    private final GamePlayer gamePlayer;
    private final Game game;

    public ToolsShopMenu(Bedwars instance, GamePlayer gamePlayer, Game game) {
    ...
    public void setItems() {
        ...
        // category items
        inventory.setItem(19, new ItemBuilder(Material.SHEARS).setDisplayName(ironCount < 20 ? "&cShears" : "&aShears").setLore("&7Cost: &f20 Iron").build());
        inventory.setItem(20, new ItemBuilder(Material.IRON_PICKAXE).setDisplayName(ironCount < 20 ? "&cIron Pickaxe" : "&aIron Pickaxe").setLore("&7Cost: &f20 Iron").build());
        inventory.setItem(21, new ItemBuilder(Material.IRON_AXE).setDisplayName(ironCount < 20 ? "&cIron Axe" : "&aIron Axe").setLore("&7Cost: &f20 Iron").build());
    }
    ...
    public void handleClick(InventoryClickEvent e) throws Exception {
        ...
        switch (itemStack.getType()) {
            case SHEARS:
                ...
                gamePlayer.removeItem(Material.IRON_INGOT, 20);
                gamePlayer.giveItem(new ItemBuilder(Material.SHEARS).setUnbreakable(true));
                break;
            ...
            case IRON_PICKAXE:
                ...
                gamePlayer.removeItem(Material.IRON_INGOT, 20);
                gamePlayer.giveItem(new ItemBuilder(Material.IRON_PICKAXE).setUnbreakable(true));
                break;
            ...
            case IRON_AXE:
                ...
                gamePlayer.removeItem(Material.IRON_INGOT, 20);
                gamePlayer.giveItem(new ItemBuilder(Material.IRON_AXE).setUnbreakable(true));
                break;
